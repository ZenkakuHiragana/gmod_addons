...
function SWEP:SetupWeaponHoldTypeForAI(t)
	...
	elseif t == "shotgun" or t == "passive" then
		...
		self.ActivityTranslateAI [ ACT_IDLE_AIM_RELAXED ] 			= ACT_IDLE_SHOTGUN_RELAXED
		self.ActivityTranslateAI [ ACT_IDLE_AIM_STIMULATED ] 		= ACT_IDLE_AIM_RIFLE_STIMULATED
		...
		self.ActivityTranslateAI [ ACT_CROUCH ] 				    = ACT_IDLE_ANGRY_SHOTGUN
		self.ActivityTranslateAI [ ACT_CROUCHIDLE ] 				= ACT_IDLE_ANGRY_SHOTGUN
		self.ActivityTranslateAI [ ACT_COVER_LOW ] 					= ACT_IDLE_ANGRY_SHOTGUN
		self.ActivityTranslateAI [ ACT_RANGE_AIM_LOW ] 				= ACT_IDLE_ANGRY_SHOTGUN
	...
	elseif t == "melee" then
		...
		self.ActivityTranslateAI [ ACT_RELOAD ] 					= ACT_IDLE_ANGRY_MELEE
		self.ActivityTranslateAI [ ACT_IDLE ] 						= ACT_IDLE_ANGRY_MELEE
		...
		self.ActivityTranslateAI [ ACT_WALK_AGITATED ] 				= ACT_WALK_AGITATED
		
		self.ActivityTranslateAI [ ACT_RUN_RELAXED ] 				= ACT_RUN
		self.ActivityTranslateAI [ ACT_RUN_STIMULATED ] 			= ACT_RUN_STIMULATED
		self.ActivityTranslateAI [ ACT_RUN_AGITATED ] 				= ACT_RUN_AGITATED
		
		self.ActivityTranslateAI [ ACT_IDLE_AIM_RELAXED ] 			= ACT_IDLE_AIM_RELAXED
		self.ActivityTranslateAI [ ACT_IDLE_AIM_STIMULATED ] 		= ACT_IDLE_AIM_STIMULATED
		self.ActivityTranslateAI [ ACT_IDLE_AIM_AGITATED ] 			= ACT_IDLE_AIM_AGITATED
		
		self.ActivityTranslateAI [ ACT_WALK_AIM_RELAXED ] 			= ACT_WALK_AIM_RELAXED
		self.ActivityTranslateAI [ ACT_WALK_AIM_STIMULATED ] 		= ACT_WALK_AIM_STIMULATED
		self.ActivityTranslateAI [ ACT_WALK_AIM_AGITATED ] 			= ACT_WALK_AIM_AGITATED
		
		self.ActivityTranslateAI [ ACT_RUN_AIM_RELAXED ] 			= ACT_RUN_AIM_RELAXED
		self.ActivityTranslateAI [ ACT_RUN_AIM_STIMULATED ] 		= ACT_RUN_AIM_STIMULATED
		self.ActivityTranslateAI [ ACT_RUN_AIM_AGITATED ] 			= ACT_RUN_AIM_AGITATED
		...
		self.ActivityTranslateAI [ ACT_GESTURE_RANGE_ATTACK1 ] 		= ACT_GESTURE_MELEE_ATTACK_SWING
		self.ActivityTranslateAI [ ACT_GESTURE_MELEE_ATTACK1 ] 		= ACT_GESTURE_MELEE_ATTACK_SWING
		
		self.ActivityTranslateAI [ ACT_CROUCH ] 				    = ACT_IDLE_ANGRY_MELEE
		self.ActivityTranslateAI [ ACT_CROUCHIDLE ] 				= ACT_IDLE_ANGRY_MELEE
		...
		self.ActivityTranslateAI [ ACT_RANGE_ATTACK1_LOW ] 			= ACT_GESTURE_MELEE_ATTACK_SWING
		self.ActivityTranslateAI [ ACT_RELOAD_LOW ] 				= ACT_GESTURE_MELEE_ATTACK_SWING
		self.ActivityTranslateAI [ ACT_GESTURE_RELOAD ] 			= ACT_GESTURE_MELEE_ATTACK_SWING
