--[[
	Hero Roller Replica is a weapon in Splatoon.
]]

SWEP.Author = "Himajin Jichiku"
SWEP.Contact = "none"
SWEP.Purpose = "Splatoon's Hero Roller Replica beta"
...
SWEP.FixAng = Angle(90, 0, 0)	--Hero Roller Replica has a different angle from other rollers.
...
SWEP.PrintName = "Hero Roller Replica"
SWEP.Slot = 0
SWEP.SlotPos = 4
SWEP.DrawAmmo = true
...
SWEP.VElements = {
	["element_name"] = { 
	type = "Model", 
	model = "models/props_splatoon/weapons/primaries/hero_roller/hero_roller.mdl", 
	bone = "ValveBiped.Bip01_R_Hand", 
	rel = "", 
	pos = Vector(17, -1.5, -3.5), 
