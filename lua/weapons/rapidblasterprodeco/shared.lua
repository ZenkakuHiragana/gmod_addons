--[[
	Rapid Blaster Pro is a weapon in Splatoon.
]]
...
SWEP.Contact = "none"
SWEP.Purpose = "Splatoon's Rapid Blaster Pro Deco beta"
...
SWEP.PrintName = "Rapid Blaster Pro Deco"
SWEP.Slot = 2
SWEP.SlotPos = 4
SWEP.DrawAmmo = true
