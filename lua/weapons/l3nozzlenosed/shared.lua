--[[
	L-3 Nozzlenose D is a weapon in Splatoon.
]]

SWEP.ShootSound = {
	Sound("SplatoonSWEPs/shooter/L3nozzlenose00.mp3")
}
SWEP.Author = "Himajin Jichiku"
SWEP.Contact = "none"
SWEP.Purpose = "Splatoon's L-3 Nozzlenose D beta"
...
SWEP.SplashLen = 232		--The length between splashes
SWEP.SplashPattern = 10
SWEP.SplashSpread = 15
SWEP.V0 = 1600
SWEP.InkRadius = 32
SWEP.FallTimer = 240
SWEP.FiringSpeed = 127.55102
SWEP.StopReloading = 25
SWEP.ShootCount = 0
...
SWEP.PrintName = "L-3 Nozzlenose D"
SWEP.Slot = 2
SWEP.SlotPos = 6
SWEP.DrawAmmo = true
