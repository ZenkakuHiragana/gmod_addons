--[[
	Neo Splash-o-Matic is a weapon in Splatoon.
]]

SWEP.ShootSound = {
	Sound("SplatoonSWEPs/shooter/splash-o-matic00.mp3")
}
SWEP.Author = "Himajin Jichiku"
SWEP.Contact = "none"
SWEP.Purpose = "Splatoon's Neo Splash-o-Matic beta"
...
SWEP.PrintName = "Neo Splash-o-Matic"
SWEP.Slot = 1
SWEP.SlotPos = 7
SWEP.DrawAmmo = true
