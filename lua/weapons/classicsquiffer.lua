--[[
	Classic Squiffer is a weapon in Splatoon.
]]

SWEP.ShootSound = {
	Sound("SplatoonSWEPs/charger/squelcher00.mp3"),
	Sound("SplatoonSWEPs/charger/squelcher00.mp3")
}
SWEP.Author = "Himajin Jichiku"
SWEP.Contact = "none"
SWEP.Purpose = "Splatoon's Classic Squiffer beta"
...
SWEP.PrintName = "Classic Squiffer"
SWEP.Slot = 5
SWEP.SlotPos = 2
SWEP.DrawAmmo = true
...
SWEP.VElements = {
	["element_name"] = { 
	type = "Model", 
	model = "models/props_splatoon/weapons/primaries/squiffer/squiffer.mdl", 
