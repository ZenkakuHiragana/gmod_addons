--[[
	Sploosh-o-Matic 7 is a weapon in Splatoon.
]]
...
SWEP.Contact = "none"
SWEP.Purpose = "Splatoon's Sploosh-o-Matic 7 beta"
...
SWEP.Primary.Splash1 = 0.06
SWEP.Primary.Splash2 = 0.038

local ShootSound = Sound("Breakable.Flesh")

SWEP.PrintName = "Sploosh-o-Matic 7"
SWEP.Slot = 1
SWEP.SlotPos = 9
SWEP.DrawAmmo = true
