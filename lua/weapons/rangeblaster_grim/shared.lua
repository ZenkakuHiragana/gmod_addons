--[[
	Grim Range Blaster is a weapon in Splatoon.
]]
...
SWEP.Contact = "none"
SWEP.Purpose = "Splatoon's Grim Range Blaster beta"
...
local ShootSound = Sound("SplatoonSWEPs/shooter/96gallon00.mp3")

SWEP.PrintName = "Grim Range Blaster"
SWEP.Slot = 2
SWEP.SlotPos = 2
SWEP.DrawAmmo = true
