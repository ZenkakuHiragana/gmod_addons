--[[
	Octoshot Replica is a weapon in Splatoon.
]]
...
SWEP.Contact = "none"
SWEP.Purpose = "Splatoon's Octoshot Replica beta"
...
SWEP.PrintName = "Octoshot Replica"
SWEP.Slot = 1
SWEP.SlotPos = 8
SWEP.DrawAmmo = true
...
SWEP.VElements = {
	["element_name"] = { 
	type = "Model", 
	model = "models/props_splatoon/weapons/primaries/octoshot/octoshot.mdl", 
	bone = "ValveBiped.Bip01_Spine4", 
	rel = "", 
	pos = Vector(6.3, -24.3, -7), 
