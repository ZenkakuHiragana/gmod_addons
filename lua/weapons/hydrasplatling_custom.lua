--[[
	Custom Hydra Splatling is a weapon in Splatoon.
]]

SWEP.Author = "Himajin Jichiku"
SWEP.Contact = "none"
SWEP.Purpose = "Splatoon's Custom Hydra Splatling beta"
...
SWEP.Charge1 = Sound("SplatoonSWEPs/splatling/hydrasplatling00.mp3")
SWEP.Charge2 = Sound("SplatoonSWEPs/splatling/hydrasplatling01.mp3")
SWEP.Charged = Sound("SplatoonSWEPs/splatling/hydrasplatling02.wav")
SWEP.ShootSound = {
...
SWEP.InkRadius = 22
SWEP.FallTimer = 340
SWEP.Range = SWEP.FallTimer * 0.000021 --for crosshair
SWEP.FiringSpeed = 155.05618
SWEP.ChargingSpeed = 103.37079
SWEP.StopReloading = 40		--Stop reloading several frames after firing weapon.
SWEP.ChargeSpeed = 0.69444444
SWEP.ChargeSpeed2 = 2.7777778
SWEP.FireLast = 216
SWEP.ShootCount = 0

SWEP.PrintName = "Custom Hydra Splatling"
SWEP.Slot = 4
SWEP.SlotPos = 1
SWEP.DrawAmmo = true
...
SWEP.VElements = {
	["element_name"] = {
		type = "Model",
		model = "models/props_splatoon/weapons/primaries/hydra_splatling/hydra_splatling.mdl",
		bone = "ValveBiped.Bip01_L_Hand",
		rel = "",
		pos = Vector(-2.7, 2.7, 2.5),
