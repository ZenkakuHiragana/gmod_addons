--SubWeapon: Quick bomb
SWEP.Secondary.ClipSize = -1
SWEP.Secondary.DefaultClip = -1
SWEP.Secondary.Automatic = false
SWEP.Secondary.Ammo = "none"
SWEP.Secondary.TakeAmmo = SWEP.Primary.ClipSize / 4
...
function SWEP:Throw()
	...
	local proj = ents.Create("splat_burstbomb")
	proj:SetOwner(self.Owner)
	proj:SetC(Vector(self.ProjColor.r / 255, self.ProjColor.g / 255, self.ProjColor.b / 255))
	proj:SetPos(pos)
	proj:SetAngles(self.Owner:EyeAngles() + Angle(0, 0, 30))
