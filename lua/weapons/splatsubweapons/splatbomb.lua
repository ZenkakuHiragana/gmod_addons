...
function SWEP:Throw()
	...
	local f, up = 0, 0
	local pos = self.Owner:GetForward() * self.Forward * 2 + self.Owner:GetRight() * self.Right + self.Owner:GetUp() * (self.Upward + 5)
	...
	local proj = ents.Create("splat_splatbomb")
