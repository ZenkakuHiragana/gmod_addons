--[[
	Bamboozler 14 MK I is a weapon in Splatoon.
]]
...
SWEP.Contact = "none"
SWEP.Purpose = "Splatoon's Bamboozler 14 MK I beta"
...
SWEP.Right = 10
SWEP.Upward = -10
SWEP.SplashMul = 5		--The lower charge, the longer length
SWEP.SplashLen = 30		--The length between splashes
SWEP.SplashSpread = 3
SWEP.SplashPattern = 2
SWEP.Range = 800
SWEP.Width = 18
SWEP.V0 = 1600
SWEP.InkRadius = 20
...
SWEP.PrintName = "Bamboozler 14 MK I"
SWEP.Slot = 5
SWEP.SlotPos = 1
SWEP.DrawAmmo = true
