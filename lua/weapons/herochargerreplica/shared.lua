--[[
	Hero Charger Replica is a weapon in Splatoon.
]]
...
SWEP.Contact = "none"
SWEP.Purpose = "Splatoon's Splat charger beta"
...
SWEP.PrintName = "Hero Charger Replica"
SWEP.Slot = 5
SWEP.SlotPos = 5
SWEP.DrawAmmo = true
...
SWEP.VElements = {
	["element_name"] = { 
	type = "Model", 
	model = "models/props_splatoon/weapons/primaries/hero_charger/hero_charger.mdl", 
