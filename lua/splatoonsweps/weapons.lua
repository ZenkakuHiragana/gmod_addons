...
function ss.DefaultParams.weapon_splatoonsweps_slosher_base(weapon)
	weapon.Parameters = {
		...
		mFirstGroupBulletFirstCollsionRadiusForField = 5,
		mFirstGroupBulletAfterCollsionRadiusForFieldOffset = 1,
		mFirstGroupBulletFirstCollsionRadiusForPlayer = 7,
		mFirstGroupBulletAfterCollsionRadiusForPlayerOffset = 1,
		...
		mSecondGroupBulletFirstCollsionRadiusForField = 8,
		mSecondGroupBulletAfterCollsionRadiusForFieldOffset = -2,
		mSecondGroupBulletFirstCollsionRadiusForPlayer = 10,
		mSecondGroupBulletAfterCollsionRadiusForPlayerOffset = -2,
		...
		mThirdGroupBulletFirstCollsionRadiusForField = 4,
		mThirdGroupBulletAfterCollsionRadiusForFieldOffset = -1,
		mThirdGroupBulletFirstCollsionRadiusForPlayer = 6,
		mThirdGroupBulletAfterCollsionRadiusForPlayerOffset = -1,
