...
ENT.classname = "nextbot_bastion"

ENT.Base = "base_nextbot"
ENT.Type = "nextbot"

ENT.PrintName = "Nextbot Bastion"
...
ENT.Model = "models/bastion/bastion.mdl"
...
ENT.Act.Walk = ACT_RUN
ENT.Act.WalkCrouch = ACT_WALK_CROUCH
...
function ENT:IsHearingSound(t)
	return math.log10(t.Entity:GetPos():DistToSqr(self:GetPos())) < t.SoundLevel * 0.085
end
