...
function ENT:GetAct(t)
	if IsValid(self.Weapon) then
		...
		if self.HoldType == "smg" then
			...
			self.ActivityTranslateAI [ ACT_WALK_AIM ] 					= ACT_WALK_SMG1
			self.ActivityTranslateAI [ ACT_RUN_AIM ] 					= ACT_RUN_SMG1
			...
			self.ActivityTranslateAI [ ACT_GESTURE_RANGE_ATTACK_LOW ]	= ACT_GESTURE_RANGE_ATTACK_SMG1_LOW
